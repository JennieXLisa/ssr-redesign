...
Implement source-bound observation models first, then deterministic score/grouping and canonical task promotion. Add conditional wrapper/channel summaries through the result contract. Provision optional analyzer adapters last, with no target execution or whole-scan admission barrier.
...
|---:|---|---|---|
| 1 | P2-F01 | P1-F02, P4-F04 | All P2-F01 completion tests plus referenced regressions |
| 2 | P2-F02 | P2-F01, P6-F01 | All P2-F02 completion tests plus referenced regressions |
| 3 | P2-F03 | P2-F01, P3-F01, P4-F03 | All P2-F03 completion tests plus referenced regressions |
| 4 | P2-F04 | P2-F01, P4-F01, P6-F03 | All P2-F04 completion tests plus referenced regressions |
