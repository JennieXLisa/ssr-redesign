...
Reuse pool/leases and implement collaborative readiness/selection first; add wait/yield transitions and race-safe reconciliation, then atomic budgets/host resources and closure. Validate with virtual-clock loads including 100 slots before any live scale claim.
...
|---:|---|---|---|
| 1 | P6-F01 | P3-F03, P5-F01, P6-F03, P7-F02 | All P6-F01 completion tests plus referenced regressions |
| 2 | P6-F02 | P1-F04, P3-F03, P1-F08 | All P6-F02 completion tests plus referenced regressions |
| 3 | P6-F03 | P6-F01, P6-F02, P1-F08 | All P6-F03 completion tests plus referenced regressions |
| 4 | P6-F04 | P4-F01, P5-F03, P6-F02, P6-F03 | All P6-F04 completion tests plus referenced regressions |
