...
Create characterization baselines and complete integration fixtures, execute per-feature and cross-system tests, then separately run approved live gateway/quality experiments. Produce an evidence-backed release handoff rather than infer success from document completeness.
...
|---:|---|---|---|
| 1 | P8-F01 | P1-F02, P3-F03, P4-F02, P5-F02, P6-F04, P7-F02 | All P8-F01 completion tests plus referenced regressions |
| 2 | P8-F02 | P8-F01, P7-F02 | All P8-F02 completion tests plus referenced regressions |
| 3 | P8-F03 | P8-F01, P8-F02, P7-F03 | All P8-F03 completion tests plus referenced regressions |
