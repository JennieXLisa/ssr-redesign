...
**Contract-hardening revision:** apply the concrete corrections in [P5-F02/IMPLEMENTATION_PLAN.md](P5-F02/IMPLEMENTATION_PLAN.md) and the [hardening index](../../CONTRACT_HARDENING.md). Earlier summary wording is not a substitute for the exact input, receipt, state, synthesis, context and cutover contracts.
