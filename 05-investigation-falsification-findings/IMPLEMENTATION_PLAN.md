...
Separate argument-ready and final-ready validation, implement candidate-specific admissions across all gates, then independent falsification/promotions and current-finding queries. Ship counterevidence hold/revision/export checks before enabling early current findings.
...
|---:|---|---|---|
| 1 | P5-F01 | P1-F05, P3-F03, P4-F01, P6-F01 | All P5-F01 completion tests plus referenced regressions |
| 2 | P5-F02 | P5-F01, P4-F01, P5-F03, P7-F02 | All P5-F02 completion tests plus referenced regressions |
| 3 | P5-F03 | P4-F03, P5-F01, P5-F02 | All P5-F03 completion tests plus referenced regressions |
