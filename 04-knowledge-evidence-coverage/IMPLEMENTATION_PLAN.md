...
Implement artifact registry and per-turn contribution receipts first. Integrate availability and consumer visibility, then exact coverage adoption/file publication, knowledge revisions and material-dependency propagation. Preserve separate transcript storage.
...
|---:|---|---|---|
| 1 | P4-F01 | P1-F03, P1-F08 | All P4-F01 completion tests plus referenced regressions |
| 2 | P4-F02 | P4-F01, P3-F03 | All P4-F02 completion tests plus referenced regressions |
| 3 | P4-F03 | P4-F01, P5-F03 | All P4-F03 completion tests plus referenced regressions |
| 4 | P4-F04 | P1-F03, P4-F01 | All P4-F04 completion tests plus referenced regressions |
