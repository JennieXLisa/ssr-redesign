...
3. Record declared types, access modifiers and source ranges without replacing unavailable semantic type information with defaults.
...
5. Prove both adapters through the worker-to-published-index path, not only grammar node matching.
