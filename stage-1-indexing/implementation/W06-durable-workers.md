...
4. Implement retry classification, pause/resume, exhausted failures and startup reconciliation as specified in execution.md. Preserve successful components on every retry path.
