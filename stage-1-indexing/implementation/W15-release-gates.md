...
4. Run a pinned representative repository/ruleset at 2, 4 and 8 heavy workers. Report elapsed times separately for capture, extraction, resolution, flagging, database publication and source queries, with RSS and failures. Do not claim earlier chat estimates are benchmarks.
