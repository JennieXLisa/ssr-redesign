# P1-F02: preserved approved requirements

Extracted verbatim from the last individually discussed document. References to a detail being open describe its historical approval status; the completed design in [TOOLS](../../../contracts/TOOLS.md), [STATE](../../../contracts/STATE.md) and [CONFIGURATION](../../../contracts/CONFIGURATION.md) now supplies that detail under delegated authority. No historical statement is relabeled individually user-approved.
