...
Start with execution/reference/error/operation contracts, then broaden access and navigation. Add portable saving and repair policy before lead/reporting and batch integration. Turn-level artifact acceptance and durable availability/notices are integrated with Phase 4 rather than enabled through private-result shortcuts.
...
|---:|---|---|---|
| 1 | P1-F01 | Baseline / shared contracts | All P1-F01 completion tests plus referenced regressions |
| 2 | P1-F02 | P1-F01, P1-F03, P1-F07, P1-F08, P1-F09 | All P1-F02 completion tests plus referenced regressions |
| 3 | P1-F03 | P1-F01, P1-F07, P1-F08 | All P1-F03 completion tests plus referenced regressions |
| 4 | P1-F04 | P1-F03, P1-F08 | All P1-F04 completion tests plus referenced regressions |
| 5 | P1-F05 | P1-F03, P1-F04, P1-F07, P1-F08 | All P1-F05 completion tests plus referenced regressions |
| 6 | P1-F06 | P1-F03, P1-F07, P1-F08, P4-F01, P5-F01 | All P1-F06 completion tests plus referenced regressions |
| 7 | P1-F07 | P1-F03 | All P1-F07 completion tests plus referenced regressions |
| 8 | P1-F08 | P1-F07 | All P1-F08 completion tests plus referenced regressions |
| 9 | P1-F09 | P1-F02, P1-F07, P1-F08 | All P1-F09 completion tests plus referenced regressions |
